...
@lru_cache(maxsize=1)
def scoresway_scraper() -> ModuleType:
    return _load_module("legacy_scoresway_scraper", "sw_scraping_fun.py")


@lru_cache(maxsize=1)
def scoresway_parser() -> ModuleType:
    return _load_module("legacy_scoresway_parser", "sw_json2csv_fun.py")
